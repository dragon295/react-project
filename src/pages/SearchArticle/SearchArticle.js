                    ...
                    <Row className="d-flex justify-content-between">
                        <div className="title-web d-flex">
                            ...
                            <div className="column-black float-left mb-4 d-flex justify-content-center align-items-center">
                                <label className="tkbv my-0">Tìm kiếm bài viết</label>
                            </div>
                        </div>
                    ...
                    <Row className="result-search">
                        <Col xs={12} sm={12} md={12} lg={12} xl={12} className="result-search-1">
                            <div className="text-tim-kiem mb-3">
                                <span className="text-tim-kiem mr-1">KẾT QUẢ TÌM KIẾM CHO:</span>
                                <span className="text-tim-kiem-1"> Death Stranding</span>
                            </div>
                            <div className="line-green mb-3" />
                            <div className="mb-3">
                                <span className="text-tim-kiem-2">4 kết quả tìm kiếm</span>
                            </div>
                        </Col>
                    </Row>
                    <Row>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul className="pagination bg-dark">
                                        <li className="page-item">
                                            <button className="page-link page-bg" aria-label="Previous" onClick={() => { window.location.href = "/search-article" }}>
                                        ...
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/search-article" }}>2</button></li>
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/search-article" }}>3</button></li>
                                        <li className="page-item">
                                            <div className="page-link page-another">...</div>
                                        </li>
                                        <li className="page-item">
                                            <button className="page-link page-bg" to="#" aria-label="Next" onClick={() => { window.location.href = "/search-article" }}>
                        ...
                        <Col xs={12} sm={12} md={4} lg={4} xl={4} className="float-right group-img-ketnoi h-100">
                            ...
                            <div className="img-fb">
                                <Link to="https://www.facebook.com/" alt="" className="link-bv">
