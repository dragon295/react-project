...
function TagDesperados() {
    document.title = "Tag - Desperados";
    useEffect(() => {
        window.scrollTo(0, 0)
    }, [])
    return (
                    ...
                    <Row className="result-search">
                        <Col xs={12} sm={12} md={12} lg={12} xl={12} className="result-search-1">
                            <div className="text-tim-kiem mb-3">
                                ...
                                <span className="text-tim-kiem-1">Desperados</span>
                            </div>
                    ...
                    <Row>
                        <Col xs={12} sm={12} md={8} lg={8} xl={8} className="d-flex flex-column bai-bao ">
                            <div className="box-all">
                                <Link to="/article-detail2" className="d-flex link-bv">
                                    <img src="https://dragon295.github.io/project-web-sale-game/img/desperados.png" alt="" className="img-fluid img-bai-viet-1" />
                                    <div className="column-green-2" />
                                    <div className="review-noi-dung px-3 py-3">
                                        <span className="title-review">Đánh giá Desperados 3: Thứ “mai thúy” của thể loại chiến thuật</span>
                                        ...
                                        <div className=" mt-2">
                                            <p className="some-text">Là phiên bản mới nhất của dòng game chiến thuật lén lút huyền thoại, Desperados 3 còn được chú ý nhiều hơn khi nó đến từ Mimimi Games – studio đã tạo ra tựa game Shadow Tactics: Blades of the Shogun...</p>
                                        </div>
                                    </div>
                                </Link>
                            </div>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul className="pagination bg-dark">
                                        <li className="page-item">
                                            <button className="page-link page-bg" aria-label="Previous" onClick={() => { window.location.href = "/tagdpd" }}>
                                        ...
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/tagdpd" }}>2</button></li>
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/tagdpd" }}>3</button></li>
                                        <li className="page-item">
                                            <div className="page-link page-another">...</div>
                                        </li>
                                        <li className="page-item">
                                            <button className="page-link page-bg" to="#" aria-label="Next" onClick={() => { window.location.href = "/tagdpd" }}>
