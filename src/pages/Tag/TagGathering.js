...
function TagGathering() {
    document.title = "Tag - Gathering Storm VI";
    useEffect(() => {
        window.scrollTo(0, 0)
    }, [])
    return (
                    ...
                    <Row className="result-search">
                        <Col xs={12} sm={12} md={12} lg={12} xl={12} className="result-search-1">
                            <div className="text-tim-kiem mb-3">
                                ...
                                <span className="text-tim-kiem-1">Gathering Storm VI</span>
                            </div>
                    ...
                    <Row>
                        <Col xs={12} sm={12} md={8} lg={8} xl={8} className="d-flex flex-column bai-bao ">
                            <div className="box-all">
                                <Link to="/article-detail4" className="d-flex link-bv">
                                    <img src="https://dragon295.github.io/project-web-sale-game/img/Gathering-Storm.jpg" alt="" className="img-fluid img-bai-viet-1" />
                                    <div className="column-green-2" />
                                    <div className="review-noi-dung px-3 py-3">
                                        <span className="title-review">Gathering Storm VI lối chơi có gì đặc biệt so với bản trước ?</span>
                                        ...
                                        <div className=" mt-2">
                                            <p className="some-text">Civilization VI đã kể một câu chuyện thẳng thắn về hậu quả của hành động của bạn. Thất bại trong việc giữ cho người của bạn hạnh phúc và họ sẽ bỏ búa và nâng cao cây chĩa. Hãy thô lỗ với các nhà lãnh đạo khác...</p>
                                        </div>
                                    </div>
                                </Link>
                            </div>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul className="pagination bg-dark">
                                        <li className="page-item">
                                            <button className="page-link page-bg" aria-label="Previous" onClick={() => { window.location.href = "/tagsg" }}>
                                        ...
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/tagsg" }}>2</button></li>
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/tagsg" }}>3</button></li>
                                        <li className="page-item">
                                            <div className="page-link page-another">...</div>
                                        </li>
                                        <li className="page-item">
                                            <button className="page-link page-bg" to="#" aria-label="Next" onClick={() => { window.location.href = "/tagsg" }}>
