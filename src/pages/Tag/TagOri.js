...
function TagOri() {
    document.title = "Tag - Ori and the Will of the Wisps";
    useEffect(() => {
        window.scrollTo(0, 0)
    }, [])
    return (
                    ...
                    <Row className="result-search">
                        <Col xs={12} sm={12} md={12} lg={12} xl={12} className="result-search-1">
                            <div className="text-tim-kiem mb-3">
                                ...
                                <span className="text-tim-kiem-1">Ori</span>
                            </div>
                    ...
                    <Row>
                        <Col xs={12} sm={12} md={8} lg={8} xl={8} className="d-flex flex-column bai-bao ">
                            <div className="box-all">
                                <Link to="/article-detail3" className="d-flex link-bv">
                                    <img src="https://dragon295.github.io/project-web-sale-game/img/ori.jpg" alt="" className="img-fluid img-bai-viet-1" />
                                    <div className="column-green-2" />
                                    <div className="review-noi-dung px-3 py-3">
                                        <span className="title-review">Ori and the Will of the Wisps được đánh giá như thế nào ?</span>
                                        ...
                                        <div className=" mt-2">
                                            <p className="some-text">Ori and the Will of the Wisps có thể sẽ là game đi cảnh xuất sắc nhất năm 2019, trừ khi phần tiếp theo của Hollow Knight làm được điều bất ngờ. Là phần tiếp theo của một tựa game tuyệt vời cũng như ...</p>
                                        </div>
                                    </div>
                                </Link>
                            </div>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul className="pagination bg-dark">
                                        <li className="page-item">
                                            <button className="page-link page-bg" aria-label="Previous" onClick={() => { window.location.href = "/tagori" }}>
                                        ...
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/tagori" }}>2</button></li>
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/tagori" }}>3</button></li>
                                        <li className="page-item">
                                            <div className="page-link page-another">...</div>
                                        </li>
                                        <li className="page-item">
                                            <button className="page-link page-bg" to="#" aria-label="Next" onClick={() => { window.location.href = "/tagori" }}>
