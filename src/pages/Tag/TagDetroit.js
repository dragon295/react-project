...
function TagDetroit() {
    document.title = "Tag - Detroit Become Human";
    useEffect(() => {
        window.scrollTo(0, 0)
    }, [])
    return (
                    ...
                    <Row className="result-search">
                        <Col xs={12} sm={12} md={12} lg={12} xl={12} className="result-search-1">
                            <div className="text-tim-kiem mb-3">
                                ...
                                <span className="text-tim-kiem-1">Detroit</span>
                            </div>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul className="pagination bg-dark">
                                        <li className="page-item">
                                            <button className="page-link page-bg" aria-label="Previous" onClick={() => { window.location.href = "/tagdbh" }}>
                                        ...
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/tagdbh" }}>2</button></li>
                                        <li className="page-item"><button className="page-link page-bg" onClick={() => { window.location.href = "/tagdbh" }}>3</button></li>
                                        <li className="page-item">
                                            <div className="page-link page-another">...</div>
                                        </li>
                                        <li className="page-item">
                                            <button className="page-link page-bg" to="#" aria-label="Next" onClick={() => { window.location.href = "/tagdbh" }}>
